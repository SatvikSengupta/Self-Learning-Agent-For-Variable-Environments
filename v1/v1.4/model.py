...
class VisionActorCritic(nn.Module):
    def __init__(self):
        ...
        # =================================================================
        # 2. ACTOR HEAD (Policy)
        # Outputs target joint angles for (Shoulder, Elbow, Wrist, Neck)
        # =================================================================
        self.actor_mean = nn.Linear(512, 4) # CHANGED FROM 3 TO 4
        ...
        self.actor_logstd = nn.Parameter(torch.full((1, 4), -1.0)) # CHANGED FROM 3 TO 4
